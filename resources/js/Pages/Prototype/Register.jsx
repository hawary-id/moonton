                        ...
                        <form className="w-[370px]">
                            <div className="flex flex-col gap-6">
                                ...
                                <InputLabel value="Full Name"/>
                                    <TextInput type="text" name="fullname" placeholder="Your fullname" value="Angga React"/>
                                </div>
                                <div>
                                    <InputLabel value="Email Address"/>
                                    <TextInput type="email" name="email" placeholder="Your Email Address" value="syamsul@moonton.com"/>
                                </div>
                                <div>
